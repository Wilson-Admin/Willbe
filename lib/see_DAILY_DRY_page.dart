...
class See_DAILY_DRY_page extends StatefulWidget {

  View_DAILY? view_DAILY;
  See_DAILY_DRY_page({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  @override
  State<See_DAILY_DRY_page> createState() => See_DAILY_DRY_pageState(view_DAILY:this.view_DAILY);
}

class See_DAILY_DRY_pageState extends State<See_DAILY_DRY_page> {
  ...
  View_DAILY? view_DAILY;
  See_DAILY_DRY_pageState({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("${DAILY_MT_TYPE_ITEMs.firstWhere((e)=>e.ITEM_NO=="DRY").ITEM_NM}", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
