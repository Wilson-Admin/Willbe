...
class Edit_DAILY_NOT_page extends StatefulWidget {

  View_DAILY? view_DAILY;
  Edit_DAILY_NOT_page({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  @override
  State<Edit_DAILY_NOT_page> createState() => Edit_DAILY_NOT_pageState(view_DAILY:this.view_DAILY);
}

class Edit_DAILY_NOT_pageState extends State<Edit_DAILY_NOT_page> {
  ...
  View_DAILY? view_DAILY;
  Edit_DAILY_NOT_pageState({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  ...
  Future<void> update_DAILY_MT_db_sub()async{
    ...
    await delete_DAILY_PIC_DL_db_sub(NO:view_DAILY!.NO,TYPE:"NOT");
...
活動_副表
  ...
  Future<void> updata_DAILY_NOT_db_sub(
    ...
    String comm = "UPDATE DAILY_NOT SET WEB_LINK='${WEB_LINK}',NOTE='${NOTE}' WHERE NO='${NO}' AND TYPE='${TYPE}'";
    dev.log("${comm}");
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("編輯${DAILY_MT_TYPE_ITEMs.firstWhere((e)=>e.ITEM_NO=="NOT").ITEM_NM}", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
            ...
            children: [
              ...
              GestureDetector(
                  ...
                  child:
                  Column(children: [
                    Center(child:Image.network(SIGN_LINK,errorBuilder: (BuildContext context, Object exception,
