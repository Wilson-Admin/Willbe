...
class See_DAILY_EAT_page extends StatefulWidget {

  View_DAILY? view_DAILY;
  See_DAILY_EAT_page({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  @override
  State<See_DAILY_EAT_page> createState() => See_DAILY_EAT_pageState(view_DAILY:this.view_DAILY);
}

class See_DAILY_EAT_pageState extends State<See_DAILY_EAT_page> {
  ...
  View_DAILY? view_DAILY;
  See_DAILY_EAT_pageState({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  ...
  Future<void> read_DAILY_EAT_db_sub({
    ...
    try{
      ...
      if(data_list.length==0){
        ...
        dev.log("DAILY_EAT_NOTE_ITEMs.length:${DAILY_EAT_NOTE_ITEMs.length}");
        for(int i=0;i<DAILY_EAT_NOTE_ITEMs.length;i++){
          if(DAILY_EAT_NOTE_ITEMs[i].ITEM_NO=="${data_list[0]["NOTE"]}"){
            ...
            dev.log("sel_DAILY_EAT_NOTE_ITEM.ITEM_NM:${sel_DAILY_EAT_NOTE_ITEM.ITEM_NM}");
            break;
          }
        }
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("${DAILY_MT_TYPE_ITEMs.firstWhere((e)=>e.ITEM_NO=="EAT").ITEM_NM}", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
            ...
            children: [
              ...
              Container(margin: EdgeInsets.only(left:8.w,right: 8.w,top: 0.h,bottom: 0.h),color: Color(0xffEEEEEE),width:ScreenUtil().screenWidth,height:50.h,child: DropdownButtonHideUnderline(
                child:Column(children: [
                  ...
                  Row(children: [
                    Text(
                      sel_DAILY_EAT_NOTE_ITEM.ITEM_NM,
                      style: TextStyle(
                        fontFamily: "GenJyuuGothic",
                        fontSize: 18.sp,
                        fontWeight: FontWeight.bold,
