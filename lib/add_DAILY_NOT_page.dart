...
class ADD_DAILY_NOT_page extends StatefulWidget {

  String type = "";
  DateTime dateTime = DateTime.now();
  ADD_DAILY_NOT_page({String type="",DateTime? dateTime}){
    this.type = type;
    this.dateTime = dateTime!;
  }

  @override
  State<ADD_DAILY_NOT_page> createState() => ADD_DAILY_NOT_pageState(type:this.type,dateTime:this.dateTime);
}

class ADD_DAILY_NOT_pageState extends State<ADD_DAILY_NOT_page> {
  ...
  String type = "";
  ADD_DAILY_NOT_pageState({String type="",DateTime? dateTime}){
    this.type = type;
    this.dateTime = dateTime!;
  }
...
DECLARE @WEB_LINK NVARCHAR(MAX) = N'${WEB_LINK_textEditingController.text}';   -- 備註內容
...
-- 8. 寫入 DAILY_NOT（備註）
INSERT INTO DAILY_NOT (TYPE, NO, NOTE,WEB_LINK)
SELECT @Type, NO,@NOTE,@WEB_LINK
FROM #NewNOs;
...
FOR JSON PATH, WITHOUT_ARRAY_WRAPPER;
  ...
  Future<void> add_all_DAILY_MT_db_sub()async{
    ...
    for(int i=0;i<_cUSTOMERs.length;i++){
      ...
      //送出活動_副表
      await insert_DAILY_NOT_db_sub(
        TYPE:"NOT",
        NO:View_DAILY_NO,//編號
        NOTE:"${NOTE_textEditingController.text}",//
        WEB_LINK:"${WEB_LINK_textEditingController.text}",//
      );
...
FOR JSON PATH, WITHOUT_ARRAY_WRAPPER;
   ...
   */
  Future<void> insert_DAILY_NOT_db_sub(
      {
        String TYPE="",//單別
        String NO="",//編號
        String NOTE="",//項目
    ...
    String comm = "INSERT INTO DAILY_NOT(TYPE,NO,NOTE,WEB_LINK) VALUES ('${TYPE}','${NO}','${NOTE}','${WEB_LINK}')";
    dev.log("${comm}");
  ...
  Future<int> read_View_DAILY_db_sub()async{
    ...
    String datetime = "${DateFormat('yyyy-MM-dd').format(dateTime!)}";
    //String comm = "SELECT * FROM DAILY_MT WHERE TYPE='NOT' AND DATE BETWEEN '${datetime} 00:00:00' AND '${datetime} 23:59:59'";
    String comm = '''SELECT *
    FROM DAILY_MT
    WHERE TYPE = 'NOT'
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("新增${DAILY_MT_TYPE_ITEMs.firstWhere((e)=>e.ITEM_NO=="NOT").ITEM_NM}", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
            ...
            children: [
              ...
              Container(
                  ...
                  child: TextFormField(
                    ...
                    controller: WEB_LINK_textEditingController,
                    keyboardType: TextInputType.multiline,
                    inputFormatters: [
                      //RemoveEmojiInputFormatter()
                      SingleQuoteToFullQuoteFormatter(),
              ...
              Row(children: [
                    ...
                    Container(
                        ...
                        child: PopupMenuButton<String>(
                            ...
                            itemBuilder: (BuildContext context) => sel_teacher_Daily_language_menu.menu[4].contants.map((e)=>PopupMenuItem<String>(
                                value: '${e}',
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: (sel_teacher_Daily_language_menu.menu[4].contants.isEmpty)?(){
