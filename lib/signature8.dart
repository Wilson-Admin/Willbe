...
class SignaturePage8 extends StatefulWidget {

  @override
  State<SignaturePage8> createState() => SignaturePage8State();
}

class SignaturePage8State extends State<SignaturePage8> {
    ...
    return GestureDetector(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                onTap: ()async{
                  ...
                  //See_DAILY_RQD_page_signaturebytes = await See_DAILY_RQD_page_signatureController.toPngBytes();
            ...
            actions: [
              TextButton(onPressed: (){
                See_DAILY_RQD_page_signatureController.clear();
      ...
      body: Container(
          ...
          child: Stack(children: [
            ...
            Signature(
              controller: See_DAILY_RQD_page_signatureController,
              ...
              Row(children: [
                ...
                GestureDetector(
                    onTap: ()async{
                      ...
                      See_DAILY_RQD_page_SING_LINK_TYPE = "手動簽名";
                      See_DAILY_RQD_page_signaturebytes = await See_DAILY_RQD_page_signatureController.toPngBytes();
                      See_DAILY_RQD_page_U_fun1!();
                      Navigator.pop(context);
