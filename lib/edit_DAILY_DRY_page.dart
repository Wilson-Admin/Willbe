...
class Edit_DAILY_DRY_page extends StatefulWidget {

  View_DAILY? view_DAILY;
  Edit_DAILY_DRY_page({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  @override
  State<Edit_DAILY_DRY_page> createState() => Edit_DAILY_DRY_pageState(view_DAILY:this.view_DAILY);
}

class Edit_DAILY_DRY_pageState extends State<Edit_DAILY_DRY_page> {
  ...
  View_DAILY? view_DAILY;
  Edit_DAILY_DRY_pageState({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  ...
  void init()async{
    ...
    await read_DAILY_DRY_db_sub(NO:view_DAILY!.NO,TYPE:view_DAILY!.TYPE);
   ...
   */
  Future<void> read_DAILY_DRY_db_sub({
    String NO="",
    String TYPE="",
})async{

    String comm = "SELECT * FROM DAILY_DRY WHERE NO='${NO}' AND TYPE='${TYPE}'";
    dev.log("${comm}");
  ...
  Future<void> update_DAILY_MT_db_sub()async{
    ...
    await updata_DAILY_MT_db_sub(
        ...
        MARK:"${NOTE_textEditingController.text}"
    );


    //送出活動_副表
    await updata_DAILY_DRY_db_sub(
      TYPE:"DRY",
      NO:view_DAILY!.NO,//編號
      NOTE:"${NOTE_textEditingController.text}",//
    );

    await delete_DAILY_PIC_DL_db_sub(NO:view_DAILY!.NO,TYPE:"DRY");
...
活動_副表
   */
  Future<void> updata_DAILY_DRY_db_sub(
      {
        String TYPE="",//單別
        String NO="",//編號
        String NOTE="",//內容
    ...
    String comm = "UPDATE DAILY_DRY SET NOTE='${NOTE}' WHERE NO='${NO}' AND TYPE='${TYPE}'";
    dev.log("${comm}");
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("編輯${DAILY_MT_TYPE_ITEMs.firstWhere((e)=>e.ITEM_NO=="DRY").ITEM_NM}", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
