...
class Edit_DAILY_MLK_page extends StatefulWidget {

  View_DAILY? view_DAILY;
  Edit_DAILY_MLK_page({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  @override
  State<Edit_DAILY_MLK_page> createState() => Edit_DAILY_MLK_pageState(view_DAILY:this.view_DAILY);
}

class Edit_DAILY_MLK_pageState extends State<Edit_DAILY_MLK_page> {
  ...
  View_DAILY? view_DAILY;
  Edit_DAILY_MLK_pageState({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("編輯${DAILY_MT_TYPE_ITEMs.firstWhere((e)=>e.ITEM_NO=="MLK").ITEM_NM}", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
            shrinkWrap: true,
