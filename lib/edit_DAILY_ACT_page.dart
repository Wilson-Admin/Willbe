...
class Edit_DAILY_ACT_page extends StatefulWidget {

  View_DAILY? view_DAILY;
  Edit_DAILY_ACT_page({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  @override
  State<Edit_DAILY_ACT_page> createState() => Edit_DAILY_ACT_pageState(view_DAILY:this.view_DAILY);
}

class Edit_DAILY_ACT_pageState extends State<Edit_DAILY_ACT_page> {
  ...
  View_DAILY? view_DAILY;
  Edit_DAILY_ACT_pageState({View_DAILY? view_DAILY}){
    this.view_DAILY = view_DAILY;
  }
  ...
  Future<void> update_DAILY_MT_db_sub()async{
    ...
    await delete_DAILY_PIC_DL_db_sub(NO:view_DAILY!.NO,TYPE:"ACT");
        ...
        child:Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                ...
                title: Text("編輯活動", style: TextStyle(fontFamily: "GenJyuuGothic",fontWeight: FontWeight.bold,color: Color(0xff292929) , fontSize: 20.sp)),
              ),
          body: ListView(
            ...
            children: [
              ...
              Container(margin: EdgeInsets.only(left:8.w,right: 8.w,top: 0.h,bottom: 0.h),color: Color(0xffEEEEEE),width:ScreenUtil().screenWidth,height:50.h,child: DropdownButtonHideUnderline(
                child: (sel_DAILY_ACT_ITEM.ITEM_NO=="")?Container():DropdownButton2<DAILY_ACT_ITEM>(
                  isExpanded: true,
