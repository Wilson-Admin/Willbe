...
class SignaturePage4 extends StatefulWidget {

  @override
  State<SignaturePage4> createState() => SignaturePageState();
}

class SignaturePageState extends State<SignaturePage4> {
    ...
    return GestureDetector(
      ...
      body: Container(
          ...
          child: Stack(children: [
            ...
            Signature(
              controller: EXCUSED_page_signatureController,
              ...
              Row(children: [
                ...
                GestureDetector(
                    onTap: ()async{
                      ...
                      EXCUSED_page_SING_LINK_TYPE="手動簽名";
                      EXCUSED_page_signaturebytes = await EXCUSED_page_signatureController.toPngBytes();
                      EXCUSED_page_U_fun1!();
                      Navigator.pop(context);
