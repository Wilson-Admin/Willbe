...
class SignaturePage3 extends StatefulWidget {

  @override
  State<SignaturePage3> createState() => SignaturePageState();
}

class SignaturePageState extends State<SignaturePage3> {
    ...
    return GestureDetector(
          ...
          appBar: CustomAppBar(
            ...
            leading: GestureDetector(
                onTap: ()async{
                  ...
                  //cUSTOMERs[0].sel_cUSTOMER_DL!.signaturebytes = await entrusted_pick_and_drop.signatureController.toPngBytes();
                  //MyHomePage2_U_fun1!();
            ...
            actions: [
              TextButton(onPressed: (){
                cUSTOMERs[0].sel_cUSTOMER_DL!.signatureController.clear();
      ...
      body: Container(
          ...
          child: Stack(children: [
            ...
            Signature(
              controller: cUSTOMERs[0].sel_cUSTOMER_DL!.signatureController,
                ...
                Row(children: [
                  ...
                  GestureDetector(
                      onTap: ()async{
                        ...
                        cUSTOMERs[0].sel_cUSTOMER_DL!.signaturebytes = await cUSTOMERs[0].sel_cUSTOMER_DL!.signatureController.toPngBytes();
                        //dev.log("${cUSTOMERs[0].cUSTOMER_DL!.signaturebytes!.length}");
                        MyHomePage2_U_fun1!();
                        Navigator.pop(context);
